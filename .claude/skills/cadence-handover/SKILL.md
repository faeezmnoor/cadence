...
2. **Mine canonical sources** (in order): repo `CLAUDE.md`, `docs/AGENT_TEAM.md`, `HANDOVER.md`, `docs/00-INDEX.md` → numbered docs, the Notion Cadence tree (via MCP), `ticket-map.json` (if present), the recent Linear epic, last 5 commits. Cite paths.
